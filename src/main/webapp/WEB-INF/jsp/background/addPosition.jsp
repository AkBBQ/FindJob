...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <fm:form method="post" class="form-x" action="${pageContext.request.contextPath}/backPosition/doAddPosition"
    modelAttribute="position">
      <div class="form-group">
       ...
       <div class="form-group">
          ...
          <div class="field">
          <fm:input path="positionName" class="input w50" placeholder="请输入职位名称" data-validate="required:请输入职位名称" />
          <div class="tips"></div>
        </div>
        </div>
      </if>
      <div class="form-group">
       ...
       <div class="field">
       <fm:input path="positionAddr" class="input w50" placeholder="请输入所属地区" data-validate="required:请输入所属地区" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
       ...
       <div class="field">
          <fm:input class="input w50" path="positionRequest" placeholder="请输入职位要求" data-validate="required:请输入职位要求" />
          <div class="tips"></div>
        </div>
      </div>
        ...
        <if condition="$iscid eq 1">
            <div class="form-group">
                ...
                <div class="field">
                    <fm:select path="categoryId" class="input w50" style="width:80px" items="${categoryList}"
       ...
       <div class="field">
       	<fm:textarea path="positionDesc" class="input w50"/>
          <div class="tips"></div>
        </div>
      </div>
        <div class="form-group">
            ...
            <div class="field">
                <fm:input path="positionPrice" class="input w50" placeholder="请输入月薪" data-validate="required:请输入月薪" />
                <div class="tips"></div>
            </div>
        </div>
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="submit"> 发布职位</button>
