        ...
        <div class="row">
            <div class="col-lg-8 col-md-6 col-xs-12">
                <div class="breadcrumb-wrapper">
                    <div class="img-wrapper">
                        <img src="${company.companyPhoto}" alt="" style="width: 100px;border-radius: 5px;">
                    </div>
                    <div class="content">

                        <h3 class="product-title">${company.companyName}</h3>

                        <p class="brand">公司人数：${company.companyPerson}</p>
                        <div class="tags">
                            <span><i class="lni-map-marker"></i> ${company.companyAddr}</span>

                            <span><i class="lni-calendar"></i> 成立时间：${company.startTime}</span>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="month-price">
                    <span class="year">融资情况</span>

                    <div class="price">${company.finance}</div>
                </div>
            </div>
        </div>
    </div>
...
<section id="featured" class="section bg-gray pb-45">
    <div class="container">
        ...
        <h4 class="small-title text-left">猜你喜欢的公司</h4>
