   ...
   <div class="col-lg-4 col-md-4 col-xs-12">
    <div class="right-sideabr">
        <div class="sider-box userinfo-box"><a href="${pageContext.request.contextPath}/resume/toAddResume" class="edit-userinfo" ka="base_info_edit">编辑</a>
            ...
            <!---->
            <div class="user-stat"><a href="#" class=""><b>475</b>沟通过 </a><a href="#" class=""><b>71</b>已投递 </a><a href="#" class=""><b>0</b>面试 </a><a href="${pageContext.request.contextPath}/user/personal" class=""><b>0</b>感兴趣 </a>
            </div>
        </div>
